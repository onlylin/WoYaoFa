...
@interface WChangePhoneViewController ()

@end

@implementation WChangePhoneViewController
                                       ...
                                       initWithEnabled:[RACSignal
                                                        combineLatest:@[
                                                                        ...
                                                                        self.codeField.rac_textSignal,
                                                                            ...
                                                                            NSNumber *enabled = @(phone.length == 11 && code.length == 4);
...
- (UIButton *)registerButton{
    if (_registerButton == nil) {
        ...
        [_registerButton setTitle:@"更换手机" forState:UIControlStateNormal];
