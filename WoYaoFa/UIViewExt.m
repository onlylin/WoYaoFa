...
-(void)setShadow{
    ...
    UIView *_layerView = [[UIView alloc] initWithFrame:CGRectMake(0, self.height / 2, self.width, self.height / 2)];
//    _layerView.bounds = self.bounds;
    ...
    _gradientLayer.startPoint = CGPointMake(0.6, 0.6);
    _gradientLayer.endPoint = CGPointMake(0.6, 1.0);
